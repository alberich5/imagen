                ...
                <div class="container-fluid">
                  ...
                  <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                      <li ><a href="{{ url('/contrato') }}">Contrato<span class="glyphicon glyphicon-list-alt" aria-hidden="true"></a></li>
                      <li><a href="{{ url('/operativo/operativo') }}">Operativo<span class="glyphicon glyphicon-fire" aria-hidden="true"></a></li>
                      <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Gestion de elementos <span  class="glyphicon glyphicon-sort-by-attributes" aria-hidden="true" ></span></a>
                        <ul class="dropdown-menu">
                          <li><a href="#">Altas</a></li>
                          <li><a href="{{ url('/operativo/baja') }}">Bajas</a></li>
                        </ul>
                      </li>
                    </ul>
